...
namespace PackIT.Api.Controllers
{
    public class PackingListsController : BaseController
    {
        ...
        public PackingListsController(IQueryDispatcher queryDispatcher, 
        ...
        {
            var query = new SearchPackingLists
            {
        ...
        public async Task<IActionResult> Post([FromBody] CreatePackingListWithItems command)
        {
            ...
            return  CreatedAtAction(nameof(Get), new { Id = command.Id }, null); // Set the 'location' header only
        }
